...
- Let an invocation remove an environment variable (#145)

## [0.2.0] - 2026-09-02

### Added

- Set variables in the environment of a command with `env` and `envs` (#139)

### Changed

- Box the invocation in `RunCommandError` and `RequireSuccessError` (#141)
...
[0.2.0]: https://github.com/aonyx-ai/kawauso/releases/tag/kawauso-process@0.2.0
[0.2.1]: https://github.com/aonyx-ai/kawauso/releases/tag/kawauso-process@0.2.1

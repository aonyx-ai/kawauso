...
Kawauso is a long-term project to build a toolkit for AI-assisted development
of Rust applications. It is a set of crates. Applications can use each crate on
its own or together with the others. During the development of these crates, we
make many decisions about architecture, infrastructure, and design.
...
- The collection of ADRs becomes the official record of our reasoning. It is
  the first thing that a new contributor reads to understand what Kawauso is
